...
SELECTED = ['Title', 'SearchDate', 'SearchParams', 'SearchQuery', 'Position', 'HistCTR', 'IsUserLoggedOn', 'Price',
 'SearchCategoryLevel', 'reg_ads', 'highlighted_ads', 'context_ads', 'user_clicks_no',
 'user_non_clicks_no', 'user_click_prob', 'weight', 'IsClick']

print("START: Reading data")
SOURCE = "data/valid3.csv"
...
TO_KEEP = ['Position', 'HistCTR', 'IsUserLoggedOn', 'Price',
 'SearchCategoryLevel', 'reg_ads', 'highlighted_ads', 'context_ads', 'user_clicks_no',
 'user_non_clicks_no', 'user_click_prob', 'day_of_week', 'hour', 'AdTitleSZ', 'SearchParamsSZ', 'SearchQuerySZ',
  'weight', 'IsClick']

print("START: writing to file")
df.to_csv("data/valid3_updated.csv", index_label = False, columns=TO_KEEP)
print("END: writing to file")

# print("START: writing to file")
# df.to_csv("data/train3_updated_all.csv", index_label = False)
# print("END: writing to file")